...
export default function Create() {
    ...
    return (
        <div className="flex w-full flex-col gap-6">
            {/* Header */}
            <PageHeader
                title={t('admin.badges.create_title')}
                description={t('admin.badges.create_description')}
            />
            ...
            <form onSubmit={submit} className="flex flex-col gap-6">
                ...
                <FormSection
                    ...
                    description={t('admin.badges.section_info_description_create')}
                >
                    <div className="flex flex-col gap-5">
                        <Input
                            ...
                            placeholder={t('admin.badges.placeholder_name')}
                            error={errors.name}
                            required
                        />
                        ...
                        <Input
                            ...
                            placeholder={t('admin.badges.placeholder_requirement')}
                        ...
                        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <Input
                                ...
                                placeholder={t('admin.badges.placeholder_category')}
                ...
                <FormSection
                    ...
                    description={t('admin.badges.section_icon_description_create')}
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            >
                                {t('admin.badges.icon_choose')}
                            </Button>

                            <span className="font-body text-micro text-gray-50">
                                {t('admin.badges.icon_hint')}
                            </span>
                        </div>
                    </div>
                ...
                <div className="flex justify-end">
                    ...
                    >
                        {processing ? t('admin.common.saving') : t('admin.badges.submit_create')}
                    </Button>
                </div>
            </form>
        </div>
