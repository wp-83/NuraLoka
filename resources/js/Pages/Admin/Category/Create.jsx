    ...
    return (
        <div className="flex w-full flex-col gap-6">
            ...
            <PageHeader
                ...
                description={t('admin.categories.create_description')}
            />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <FormSection
                    ...
                    description={t('admin.categories.section_info_description_create')}
                >
                ...
                <div className="flex justify-end">
                    ...
                    >
                        {processing ? t('admin.common.saving') : t('admin.categories.submit_create')}
                    </Button>
                </div>
            </form>
...
Create.layout = (page) => (
    <AdminLayout pageTitle="title.admin_category_create" content={page} />
);
