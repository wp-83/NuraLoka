                    ...
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <button
                            ...
                            className={`inline-flex items-center gap-2 font-medium transition-colors px-4 py-2 rounded-lg backdrop-blur-sm shadow-sm border ${
                                isSaved
                                    ? 'text-amber-600 bg-amber-50/80 border-amber-200 hover:bg-amber-100/80'
                                    : 'text-emerald-700 bg-white/50 border-emerald-100/50 hover:text-emerald-800'
                            }`}
                        >
                            {isSaved ? 'Tersimpan di daftar impian' : 'Simpan ke daftar impian'}
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-gray-800 font-medium text-sm md:text-base">
                                        {totalSaves > 0 ? `${totalSaves.toLocaleString('id-ID')} pengunjung menyimpan tempat ini` : 'Belum ada yang menyimpan'}
                                    </span>
                                </div>
                                <div className="flex items-center gap-3">
